...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Đức Hạnh Clocks — Timeless Craftsmanship for Every Home" },
      ...
      { name: "twitter:title", content: "Đức Hạnh Clocks — Timeless Craftsmanship for Every Home" },
