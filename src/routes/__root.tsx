...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Đức Hạnh Clocks — Timeless Craftsmanship for Every Home" },
      ...
      { property: "og:title", content: "Đức Hạnh Clocks — Timeless Craftsmanship" },
      { property: "og:description", content: "Elegant clocks designed with precision, warmth, and lasting beauty." },
